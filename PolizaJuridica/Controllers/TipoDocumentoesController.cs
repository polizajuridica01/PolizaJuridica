...
namespace PolizaJuridica.Controllers
{
    public class TipoDocumentoesController : Controller
    {
        ...
        public TipoDocumentoesController(PolizaJuridicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TipoDocumentoId,TipoDocumentoDesc")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoDocumentoId,TipoDocumentoDesc")] TipoDocumento tipoDocumento)
        {
