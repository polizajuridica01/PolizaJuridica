...
namespace PolizaJuridica.Migrations
{
    ...
    partial class PolizaJuridicaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolizaJuridica.Data.Eventos", b =>
                {
            ...
            modelBuilder.Entity("PolizaJuridica.Data.FiadorF", b =>
                {
                    ...
                    b.Property<string>("DistritoJudicial");

                    b.Property<string>("EscrituraNumero");
                    ...
                    b.Property<string>("Licenciado");

                    b.Property<string>("NumeroNotaria");

                    b.Property<DateTime>("PartidaFecha");

                    b.Property<string>("PartidaLibro");

                    b.Property<string>("PartidaNumero");

                    b.Property<string>("PartidaSeccion");

                    b.Property<string>("PartidaVolumen");
            ...
            modelBuilder.Entity("PolizaJuridica.Data.FiadorM", b =>
                {
                    ...
                    b.Property<string>("Licenciado1");

                    b.Property<string>("Licenciado2");

                    b.Property<string>("NombreApoderado");

                    b.Property<string>("NotariaNumero1");

                    b.Property<string>("NotariaNumero2");

                    b.Property<DateTime>("NumeralFecha");
            ...
            modelBuilder.Entity("PolizaJuridica.Data.SolicitudProceso", b =>
                {
                    b.Property<int>("SolicitudProcesoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("MotivoCancelacíon");

                    b.Property<int>("SolicitudId");

                    b.Property<int>("SolicitudProcesoEstatus");

                    b.Property<string>("SolicitudUsuario");

                    b.Property<int>("SolicitudUsuarioId");

                    b.Property<string>("fecha");

                    b.HasKey("SolicitudProcesoId");

                    b.HasIndex("SolicitudId");

                    b.ToTable("SolicitudProceso");
                });
            ...
            modelBuilder.Entity("PolizaJuridica.Data.TipoProceso", b =>
                {
            ...
            modelBuilder.Entity("PolizaJuridica.Data.Usuarios", b =>
                {
                    ...
                    b.Property<string>("UsuarioCelular");
            ...
            modelBuilder.Entity("PolizaJuridica.Data.UsuariosSolicitud", b =>
                {
                    ...
                    b.HasOne("PolizaJuridica.Data.TipoProceso", "TipoProceso")
                        .WithMany()
